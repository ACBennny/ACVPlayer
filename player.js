                ...
                <div class="cover-vid">
                    ...
                    <div class="mobile_controls_box">
                        <div class="options center mobile_controls">
                            <button type="button" class="skip-backward" title="rewind 5s" aria-label="rewind 5s">
                            ...
                            <button type="button" class="play-pause" title="play" aria-label="play">
                            ...
                            <button type="button" class="skip-forward" title="fast-forward 5s" aria-label="fast-forward 5s">
                ...
                <div class="wrapper">
                    ...
                    <ul class="video-controls">
                        <li class="options left">
                            <button type="button" class="volume" title="mute" aria-label="mute">
                        ...
                        <li class="options right">
                            <button type="button" class="pic-in-pic" title="pic-in-pic" aria-label="pic-in-pic">
                            ...
                            <button type="button" class="settingsBtn" title="settings" aria-label="settings">
                            ...
                            <button type="button" class="fullscreenBtn" title="enter fullscreen" aria-label="enter fullscreen">
